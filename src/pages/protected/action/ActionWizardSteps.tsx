...
import type { ActionKind, OrganizerKind, VisibilityKind } from './wizardTypes'
import type { WizardStepProps } from './wizardStepProps'

function WizardStep1(props: WizardStepProps) {
  const { values, patch, setValues, setStep, setImage, setGeoErr, t, tFr, baseInput, labelClass, clubCurrency: cur, isVia, isGuideOrganizer, lockActionKind, lockFerrataSelection, lockOrganizerType, ferrataCatalog, selectedFerrata, selectedGuideLabel, guideDropdownOptions, minDate, initialImageUrl, imageHelpText, image, geoQuery, setGeoQuery, geoBusy, geoErr, runGeocode, hintCenterForMountain } = props
...
function WizardStep2(props: WizardStepProps) {
  const { values, patch, t, baseInput, labelClass, clubCurrency: cur, isVia, isPublic, showSmestaj, addSmestaj } = props
  return (
...
function WizardStep3(props: WizardStepProps) {
  const { values, patch, t, baseInput, clubCurrency: cur, addOprema } = props
  return (
...
function WizardStep4(props: WizardStepProps) {
  const { values, patch, t, baseInput, clubCurrency: cur, isVia, isPublic, organizerLabel, visibilityLabel, addPrevoz, showTransport, totalOptionalPreview } = props
  return (
        <div className="space-y-5">
...
export { WizardStep1, WizardStep2, WizardStep3, WizardStep4 }
