                ...
                {filteredTransakcije.length === 0 ? (
                  ...
                  <>
                        ...
                        <tbody className="divide-y divide-gray-200">
                          {paginatedTransakcije.map((t) => (
                            <tr key={t.id} className="hover:bg-gray-50">
                              ...
                              <td className="px-6 py-3 text-sm text-gray-600 max-w-[12rem] sm:max-w-[16rem]">
                    ...
                    <div className="sm:hidden divide-y divide-gray-200">
                      {paginatedTransakcije.map((t) => (
                        <div key={t.id} className="p-4 hover:bg-gray-50">
                          ...
                          <p className="text-sm text-gray-700 mt-1 truncate max-w-full" title={t.opis || undefined}>
                            {t.opis || '—'}
                          </p>
                          {t.clanarinaKorisnik && (
                    ...
                    {totalPages > 1 && (() => {
                      ...
                      return (
                        <div className="border-t border-gray-200 bg-gray-50/70 px-3 sm:px-4 py-3 sm:py-3.5">
                          <div className="flex items-center justify-center gap-1 sm:gap-2 min-w-0 max-w-full">
                            <button
                              ...
                              className="shrink-0 inline-flex items-center justify-center gap-1 px-2.5 sm:px-3 py-2 rounded-lg text-sm font-medium text-gray-700 bg-white border border-gray-200 shadow-sm transition-colors disabled:opacity-40 disabled:pointer-events-none hover:bg-gray-50 hover:border-gray-300 active:bg-gray-100"
                            >
                              <svg className="w-4 h-4 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
                              ...
                              {pageNumbers.map((page, idx) =>
                                page === 'ellipsis' ? (
                                  ...
                                  <button
                                    ...
                                    className={`shrink-0 min-w-[2rem] w-8 h-8 sm:w-9 sm:h-9 rounded-lg text-sm font-medium transition-all ${
                                      page === safeCurrentPage
                                        ? 'bg-[#41ac53] text-white shadow-md shadow-[#41ac53]/25 ring-2 ring-[#41ac53]/30'
                          ...
                          <p className="text-center text-xs text-gray-500 mt-2 sm:mt-2.5">
                            Strana {safeCurrentPage} od {totalPages}
                          </p>
                        </div>
                      )
                    })()}
