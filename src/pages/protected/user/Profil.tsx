...
export default function Profil() {
  ...
  return (
    <div className="-mx-4 sm:-mx-6 lg:-mx-8 -mt-6 pb-16">
      ...
      {/* ═══════ Cover ═══════ */}
      <div
        className="relative h-52 sm:h-64 md:h-72 lg:h-80 xl:h-[360px] 2xl:h-[400px] select-none"
      ...
      >
        ...
        <button
          ...
          className="absolute top-4 left-4 z-20 inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-black/30 backdrop-blur-xl text-white text-xs font-medium hover:bg-black/50 transition-all duration-200 cursor-pointer border border-white/10"
        >
          {uploadingCover ? (
        ...
        {coverError && (
          <p className="absolute bottom-4 left-4 right-4 z-20 text-xs font-medium text-white bg-red-500/90 backdrop-blur-sm px-3 py-1.5 rounded-lg">
            {coverError}
          </p>
        )}
      </div>
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-end gap-4 sm:gap-6 -mt-14 sm:-mt-16 pb-6 pt-0">
                ...
                <div className="flex-1 min-w-0 text-center sm:text-left pb-0 sm:pb-1">
                  ...
                  <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-3 gap-y-1.5 mt-2">
                    <span className="text-sm text-gray-400 font-medium">@{displayUsername}</span>
            ...
            <div className="hidden lg:flex flex-col items-end gap-4 pt-6 pb-6 flex-shrink-0 w-72 xl:w-80">
              ...
              <div className="grid grid-cols-3 gap-3 w-full">
                ...
                <div className="rounded-xl bg-gradient-to-br from-amber-50 to-white border border-amber-100/60 p-3 text-center">
                  ...
                  <p className="text-[9px] text-amber-600 font-bold uppercase tracking-wider mt-0.5">osvoj.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="lg:hidden bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-3 divide-x divide-white/10">
            ...
            <div className="flex flex-col items-center py-5">
              <span className="text-lg sm:text-2xl font-extrabold text-white tracking-tight">{statistika.brojPopeoSe}</span>
              ...
              {uspesneAkcije.map((akcija) => {
                ...
                return (
                  <Link
                    key={akcija.id}
                    to={`/akcije/${akcija.id}`}
                    className="group relative bg-white rounded-2xl border border-gray-100/80 shadow-sm overflow-hidden hover:shadow-xl hover:border-gray-200 hover:-translate-y-1 transition-all duration-300 hover:no-underline"
                  >
