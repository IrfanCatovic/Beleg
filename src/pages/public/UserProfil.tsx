  ...
  return (
    <div className="-mx-4 sm:-mx-6 lg:-mx-8 pb-12">
      ...
      >
        ...
        {isOwn && !positioning && (
          <div className="absolute top-4 left-4 right-4 z-10 flex flex-wrap items-center gap-2 opacity-100 md:opacity-0 md:group-hover/cover:opacity-100 transition-opacity">
            <input
              ref={coverInputRef}
              type="file"
              accept="image/*"
            ...
            <button
              ...
              className="inline-flex min-h-[40px] items-center gap-1.5 rounded-full px-3 py-2 text-[11px] font-semibold text-white bg-black/40 hover:bg-black/55 backdrop-blur-sm border border-white/20 transition-all disabled:opacity-60 disabled:cursor-not-allowed active:scale-[0.98]"
            >
              {coverUploading ? (
