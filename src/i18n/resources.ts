...
export const resources = {
  sr: {
    ...
    appLayout: {
      ...
      explore: 'Istraži',
      myClubNav: 'Moj klub',
      exploreFerate: 'Ferate',
      exploreMountains: 'Planine i vrhovi',
      exploreGuides: 'Vodiči',
      exploreHotels: 'Hoteli i smeštaj',
      exploreMap: 'Mapa',
      exploreComingSoon: 'Uskoro',
      clubOverview: 'Pregled kluba',
      tasks: 'Zadaci',
      members: 'Članovi',
      club: 'Klub',
      finances: 'Finansije',
    ...
    actions: {
      ...
      guidedToursActive: 'Moje vođene ture (aktivne)',
      guidedToursCompleted: 'Moje vođene ture (završene)',
      guidedTourBadge: 'Vođenje',
      emptyGuidedActive: 'Nemate aktivnih vođenih tura.',
      emptyGuidedCompleted: 'Nemate završenih vođenih tura.',
      ...
      cancelled: 'Otkazana',
      actionCancelledTitle: 'Akcija je otkazana',
      cancellationReasonLabel: 'Razlog:',
      cancelledAtLabel: 'Otkazano:',
      cancelledHint: 'Akcija je otkazana. Istorijski podaci ostaju dostupni.',
      cancelledPaymentsNote: 'Evidentirane uplate nisu automatski refundirane.',
    ...
    actionDetails: {
      ...
      summitPngPer: 'PER',
      summitPngDifficulty: 'Težina',
      summitPngFerrata: 'Ferata',
      ...
      actionInviteShareTitle: 'Pozovi ekipu',
      actionInviteShareDescPublic: 'Pošalji link javne akcije preko WhatsApp-a.',
      actionInviteShareDescPrivate: 'Pošalji invite link sa tokenom — samo sa njim se može pristupiti privatnoj akciji.',
      actionInviteShareWhatsApp: 'Podeli na WhatsApp',
      actionInviteShareLoading: 'Pripremam link...',
      ...
      guideRatingTitle: 'Oceni vodiča',
      guideRatingSubtitle: 'Kako je {{name}} vodio/la ovu akciju?',
      guideRatingStarsLabel: 'Ocena',
      guideRatingStar: 'Ocena {{n}} od 5',
      guideRatingOptionalHint: 'Ocena nije obavezna — možeš preskočiti. Komentar zahteva ocenu.',
      guideRatingCommentLabel: 'Komentar (opciono)',
      guideRatingCommentPlaceholder: 'Kratak utisak o vođenju…',
      guideRatingCommentNeedsScore: 'Da biste ostavili komentar, prvo izaberite ocenu (1–5).',
      guideRatingSubmit: 'Pošalji ocenu',
      guideRatingSkip: 'Preskoči',
      guideRatingSaving: 'Šaljem…',
      guideRatingThanks: 'Hvala na oceni!',
      guideRatingError: 'Ocena nije sačuvana. Pokušajte ponovo.',
      guideRatingCardTitle: 'Oceni vodiča',
      guideRatingCardHint: 'Pomozi drugima — ostavi ocenu za {{name}}.',
      guideRatingCardButton: 'Oceni sada',
      guideRatingAlreadyTitle: 'Ocena poslata',
      guideRatingAlreadyHint: 'Već ste ocenili vodiča za ovu akciju.',
      ...
      mountain: 'Planina',
      peak: 'Vrh',
      ferrataRoute: 'Via ferrata',
      ferrataLocation: 'Lokacija',
      ferrataLength: 'Dužina ferate',
      ferrataElevationGain: 'Visinska razlika',
      ferrataRequiredGear: 'Obavezna oprema',
      viaFerrataBadge: 'Via ferrata',
      height: 'Visina',
      registered: 'Prijavljenih',
      registrationFullFriendly: 'Sva mesta su popunjena, vidimo se na sledećoj akciji!',
      sendSignupRequest: 'Pošalji zahtev za prijavu',
      signupRequestSent: 'Zahtev za prijavu je poslat na odobrenje.',
      signupPendingLabel: 'Tvoja prijava',
      signupPendingStatus: 'Na čekanju odobrenja',
      signupPendingMessage: 'Zahtev za prijavu je na čekanju odobrenja vodiča.',
      confirmCancelSignupRequest: 'Da li želite da otkažete zahtev za prijavu?',
      signupRequestsTitle: 'Zahtevi za prijavu',
      signupRequestsEmpty: 'Nema zahteva na čekanju.',
      signupAccept: 'Prihvati prijavu',
      signupReject: 'Odbij',
      loading: 'Učitavanje…',
      ...
      finishFinanceModalTitle: 'Završi akciju i finansije',
      finishFinanceTotalIncome: 'Ukupni prihod (uplate označenih kao plaćeni)',
      finishFinanceExpenseLabel: 'Rashod na akciji',
      finishFinanceExpenseHelp: 'Troškovi kluba na akciju (npr. gorivo, smeštaj). Ostavite 0 ako nema rashoda.',
      finishFinanceNetPreview: 'Neto za finansije (prihod − rashod)',
      finishFinanceConfirm: 'Potvrdi i završi',
      finishFinanceSubmitting: 'Čuvanje…',
      finishFinanceRashodInvalid: 'Rashod mora biti nenegativan broj',
      finishFinanceSuccessNone:
        'Akcija je završena. U finansije nije dodata stavka (neto je 0 ili nema prihoda za upis).',
      finishFinanceSuccessIncome: 'Akcija je završena. U finansije je upisan prihod od {{amount}} {{currency}}.',
      finishFinanceSuccessExpense: 'Akcija je završena. U finansije je upisan rashod od {{amount}} {{currency}}.',
    },
    users: {
    ...
    profileSettings: {
      ...
      currentPasswordHint: 'Obavezna samo ako menjate lozinku',
      currentPasswordRequired: 'Unesite trenutnu lozinku da biste postavili novu.',
      ...
      selfSubtitle: 'Javni, privatni i klupski podaci Planinarskog pasoša',
      saving: 'Čuvanje...',
    ...
    userProfile: {
      ...
      ascent: 'Uspon',
      trail: 'Kilometri',
      climbedCount: 'Osvojeno',
      editProfile: 'Uredi profil',
      passportShortcutTitle: 'Planinarska legitimacija i članski podaci',
      passportShortcutBody: 'Legitimacija, markica i privatni članski podaci dostupni su samo vama i ovlašćenom klubu.',
      passportShortcutCta: 'Otvori podešavanja',
      completedActions: 'Osvojene akcije',
      noCompletedActions: 'Još nema zabilježenih uspona',
      noCompletedActionsBody: 'Kada završiš planinarsku akciju, ona će postati dio tvog Planinarskog pasoša.',
      noCompletedActionsPublic: 'Ovaj korisnik još nema javno zabilježene uspone.',
      findAction: 'Pronađi akciju',
      climbed: 'Popeo se',
      actionsTabClimbed: 'Osvojene',
      actionsTabGuided: 'Vođene ture',
      guidedToursTitle: 'Vođene ture',
      noGuidedTours: 'Još nema vođenih tura',
      noGuidedToursBody: 'Ture koje budeš vodio pojaviće se ovdje kao dio tvog vodičkog iskustva.',
      noGuidedToursPublic: 'Ovaj vodič još nema javno evidentirane vođene ture.',
      statsUnavailable: 'Statistika trenutno nije dostupna.',
      historyUnavailable: 'Nismo uspjeli učitati planinarsku istoriju.',
      retry: 'Pokušaj ponovo',
      noClubOwn: 'Nisi povezan sa planinarskim klubom.',
      actionsHistoryAria: 'Planinarska istorija',
      guided: 'Vodio',
      ...
      guideReviewsLoadError: 'Greška pri učitavanju recenzija.',
      guideReviewsRatingCount: '{{count}} ocena',
    },
    finance: {
      title: 'Finansije',
    ...
    actionForms: {
      errors: {
        ...
        missingPlaninaLocation: 'Obavezna je tačka na mapi ili ispravne koordinate za planinarsku akciju.',
        invalidPlaninaCoords: 'Koordinate su van dozvoljenog opsega.',
      },
      ...
      fields: {
        ...
        planinaLocationTitle: 'Lokacija ture na mapi',
        planinaLocationHint: 'Klik na mapu, ručan unos koordinata ili pretraga mesta (OpenStreetMap / Nominatim). Obavezno za planinske akcije.',
        planinaMapPickerHint: 'Klik postavlja marker; marker se može povući.',
        planinaLatShort: 'Geografska širina (lat)',
        planinaLngShort: 'Geografska dužina (lng)',
        planinaGeocodeLabel: 'Pretraga mesta',
        planinaGeocodePlaceholder: 'npr. Midžor, Srbija',
        planinaGeocodeSearch: 'Nađi',
        planinaGeocodeSearching: 'Tražim…',
        planinaGeocodeNoResults: 'Nema rezultata.',
        planinaGeocodeMinQuery: 'Upišite bar 3 znaka u pretragu ili popunite planinu i vrh.',
      },
      placeholders: {
      ...
      wizard: {
        tabs: { basic: 'Osnovni podaci', logistics: 'Logistika', equipment: 'Oprema', transportOptions: 'Prevoz i opcije', summary: 'Opcije i pregled' },
        navigation: { back: 'Nazad', nextStep: 'Sledeći korak' },
        labels: { actionType: 'Tip akcije', organizer: 'Organizator', visibility: 'Vidljivost', viaFerrataLocation: 'Lokacija via ferrate', viaFerrataName: 'Naziv via ferrate', durationHours: 'Trajanje (sati)', registrationDeadline: 'Rok prijava', maxPeople: 'Maks. broj ljudi', departurePlace: 'Mesto polaska', contactPhone: 'Kontakt telefon', numberOfDays: 'Broj dana', price: 'Cena ({{currency}})', memberPrice: 'Cena za članove ({{currency}})', othersPrice: 'Cena za ostale ({{currency}})' },
        aria: { actionType: 'Tip akcije', organizer: 'Organizator akcije', visibility: 'Vidljivost akcije' },
        actionType: { mountain: 'Planina', viaFerrata: 'Via Ferrata', lockedHint: 'Tip akcije je zaključan prema prethodnom izboru.' },
        organizer: {
          club: 'Klubska akcija',
          guide: 'Akcija vodiča',
          guideHint: 'Ne pripada kalendaru kluba: prikazuje se u vašim vođenim turama.',
        ...
        ferrata: {
          durationFromCatalog: 'Trajanje akcije u satima računa se iz maks. vremena penjanja u katalogu ({{max}} min).',
          coverFromCatalog: 'Za via ferrata se ne dodaje posebna slika: koristi se cover fotografija izabrane ferate.',
          contactPhoneOptionalHint: 'Opciono: samo ako želite broj za organizaciju oko termina.',
          contactPhoneOptionalPlaceholder: 'npr. +381601234567',
        },
    ...
    uiExtras: {
      ...
      buttons: {
        back: 'Nazad',
        profileInfo: 'Sve informacije o korisniku',
        profileSettings: 'Podešavanja profila',
        print: 'Štampanje',
        profileSettingsMenu: 'Podešavanje',
        profileInfoMenu: 'Info',
        printMenu: 'Štampaj',
      },
      block: {
    ...
    clubs: {
      ...
      superadmin: {
        ...
        stats: {
          ...
          actionsLabel: 'Akcija',
          totalMembers: 'Članovi klubova / ukupno korisnika',
    ...
    invite: {
      ...
      adminPanel: {
        ...
        shareLinkLabel: 'Link za registraciju članova',
        copyLink: 'Kopiraj link',
        linkCopied: 'Link kopiran!',
        shareHint: 'Pošalji članovima ovaj link i kod — na prijavi biraju registraciju pomoću koda kluba.',
      },
    },
    pdf: {
  ...
  bs: {
    ...
    appLayout: {
      ...
      exploreMountains: 'Planine i vrhovi',
      exploreGuides: 'Vodiči',
      exploreHotels: 'Hoteli i smještaj',
      exploreMap: 'Mapa',
      exploreComingSoon: 'Uskoro',
      clubOverview: 'Pregled kluba',
      tasks: 'Zadaci',
    ...
    actionDetails: {
      ...
      finishFinanceTotalIncome: 'Ukupni prihod (uplate označenih kao plaćeni)',
      finishFinanceExpenseLabel: 'Rashod na akciji',
      finishFinanceExpenseHelp: 'Troškovi kluba na akciju (npr. gorivo, smještaj). Ostavite 0 ako nema rashoda.',
      finishFinanceNetPreview: 'Neto za finansije (prihod − rashod)',
      finishFinanceConfirm: 'Potvrdi i završi',
      finishFinanceSubmitting: 'Čuvanje…',
      finishFinanceRashodInvalid: 'Rashod mora biti nenegativan broj',
      finishFinanceSuccessNone:
        'Akcija je završena. U finansije nije dodana stavka (neto je 0 ili nema prihoda za upis).',
      finishFinanceSuccessIncome: 'Akcija je završena. U finansije je upisan prihod od {{amount}} {{currency}}.',
      finishFinanceSuccessExpense: 'Akcija je završena. U finansije je upisan rashod od {{amount}} {{currency}}.',
    },
    users: {
    ...
    actionForms: {
      ...
      fields: {
        ...
        planinaLocationTitle: 'Lokacija ture na mapi', planinaLocationHint: 'Klik na mapu, ručan unos koordinata ili pretraga mjesta (OpenStreetMap / Nominatim). Obavezno za planinske akcije.', planinaMapPickerHint: 'Klik postavlja marker; marker se može povući.', planinaLatShort: 'Geografska širina (lat)', planinaLngShort: 'Geografska dužina (lng)', planinaGeocodeLabel: 'Pretraga mjesta', planinaGeocodePlaceholder: 'npr. Maglić, BiH', planinaGeocodeSearch: 'Nađi', planinaGeocodeSearching: 'Tražim…', planinaGeocodeNoResults: 'Nema rezultata.', planinaGeocodeMinQuery: 'Upišite bar 3 znaka u pretragu ili popunite planinu i vrh.',
      },
      placeholders: {
  ...
  hr: {
    ...
    invite: {
      ...
      adminPanel: {
        ...
        copyLink: 'Kopiraj link',
        linkCopied: 'Link kopiran!',
        shareHint: 'Pošaljite članovima ovaj link i kod — na prijavi biraju registraciju pomoću koda kluba.',
      },
    },
    pdf: {
  ...
  de: {
    ...
    appLayout: {
      ...
      actions: 'Touren',
      explore: 'Entdecken',
      myClubNav: 'Mein Verein',
      exploreFerate: 'Klettersteige',
      exploreMountains: 'Berge & Gipfel',
      exploreGuides: 'Führer',
      exploreHotels: 'Hotels & Unterkunft',
      exploreMap: 'Karte',
      exploreComingSoon: 'Demnächst',
    ...
    actionDetails: {
      ...
      summitPngPer: 'PER',
      summitPngDifficulty: 'Schwierigkeit',
      summitPngFerrata: 'Klettersteig',
      ...
      peak: 'Gipfel',
      ferrataRoute: 'Via ferrata',
      ferrataLocation: 'Standort',
      ferrataLength: 'Ferrata-Länge',
      ferrataElevationGain: 'Höhendifferenz',
      ferrataRequiredGear: 'Pflichtausrüstung',
      viaFerrataBadge: 'Via ferrata',
      height: 'Höhe',
      registered: 'Angemeldet',
      registrationFullFriendly: 'Alle Plätze sind belegt — wir sehen uns bei der nächsten Tour!',
      sendSignupRequest: 'Anmeldung anfragen',
      signupRequestSent: 'Ihre Anmeldungsanfrage wurde zur Genehmigung gesendet.',
      signupPendingLabel: 'Ihre Anmeldung',
      signupPendingStatus: 'Wartet auf Genehmigung',
      signupPendingMessage: 'Ihre Anmeldungsanfrage wartet auf die Genehmigung des Guides.',
      confirmCancelSignupRequest: 'Möchten Sie die Anmeldungsanfrage wirklich stornieren?',
      signupRequestsTitle: 'Anmeldungsanfragen',
      signupRequestsEmpty: 'Keine ausstehenden Anfragen.',
      signupAccept: 'Annehmen',
      signupReject: 'Ablehnen',
      loading: 'Laden…',
      ...
      finishFinanceModalTitle: 'Tour abschließen und Finanzen',
      finishFinanceTotalIncome: 'Gesamteinnahmen (Summe als bezahlt markierter Beträge)',
      finishFinanceExpenseLabel: 'Ausgaben für diese Tour',
      finishFinanceExpenseHelp: 'Clubausgaben (z. B. Kraftstoff, Unterkunft). 0 lassen, wenn keine Ausgaben.',
      finishFinanceNetPreview: 'Netto für Finanzen (Einnahmen − Ausgaben)',
      finishFinanceConfirm: 'Bestätigen und abschließen',
      finishFinanceSubmitting: 'Wird gespeichert…',
      finishFinanceRashodInvalid: 'Ausgaben müssen eine nicht-negative Zahl sein',
      finishFinanceSuccessNone:
        'Die Tour wurde abgeschlossen. Es wurde kein Finanzeintrag erstellt (Netto 0 oder keine Einnahmen).',
      finishFinanceSuccessIncome: 'Die Tour wurde abgeschlossen. Als Einnahme wurden {{amount}} {{currency}} gebucht.',
      finishFinanceSuccessExpense: 'Die Tour wurde abgeschlossen. Als Ausgabe wurden {{amount}} {{currency}} gebucht.',
    },
    users: {
    ...
    uiExtras: {
      ...
      buttons: {
        back: 'Zurück',
        profileInfo: 'Alle Benutzerinformationen',
        profileSettings: 'Profileinstellungen',
        print: 'Drucken',
        profileSettingsMenu: 'Einstellungen',
        profileInfoMenu: 'Info',
        printMenu: 'Drucken',
      },
    ...
    invite: {
      ...
      adminPanel: {
        ...
        shareLinkLabel: 'Registrierungslink für Mitglieder',
        copyLink: 'Link kopieren',
        linkCopied: 'Link kopiert!',
        shareHint: 'Senden Sie Mitgliedern diesen Link und Code — bei der Anmeldung wählen sie Registrierung mit Vereinscode.',
      },
    },
    pdf: {
  ...
  en: {
    ...
    appLayout: {
      ...
      explore: 'Explore',
      myClubNav: 'My club',
      exploreFerate: 'Via ferratas',
      exploreMountains: 'Mountains & peaks',
      exploreGuides: 'Guides',
      exploreHotels: 'Hotels & lodging',
      exploreMap: 'Map',
    ...
    actions: {
      ...
      cancelled: 'Cancelled',
      actionCancelledTitle: 'Action cancelled',
      cancellationReasonLabel: 'Reason:',
      cancelledAtLabel: 'Cancelled:',
      cancelledHint: 'This action was cancelled. Historical data remains available.',
      cancelledPaymentsNote: 'Recorded payments were not automatically refunded.',
    ...
    actionDetails: {
      ...
      summitPngPer: 'PER',
      summitPngDifficulty: 'Difficulty',
      summitPngFerrata: 'Via ferrata',
      ...
      peak: 'Peak',
      ferrataRoute: 'Via ferrata',
      ferrataLocation: 'Location',
      ferrataLength: 'Ferrata length',
      ferrataElevationGain: 'Elevation gain',
      ferrataRequiredGear: 'Required gear',
      viaFerrataBadge: 'Via ferrata',
      height: 'Height',
      registered: 'Registered',
      registrationFullFriendly: 'All spots are full — see you on the next activity!',
      sendSignupRequest: 'Request to join',
      signupRequestSent: 'Your signup request has been sent for approval.',
      signupPendingLabel: 'Your signup',
      signupPendingStatus: 'Pending approval',
      signupPendingMessage: 'Your signup request is waiting for guide approval.',
      confirmCancelSignupRequest: 'Do you want to cancel your signup request?',
      signupRequestsTitle: 'Signup requests',
      signupRequestsEmpty: 'No pending requests.',
      signupAccept: 'Accept',
      signupReject: 'Reject',
      loading: 'Loading…',
      ...
      finishFinanceModalTitle: 'Finish activity and finances',
      finishFinanceTotalIncome: 'Total income (sum for participants marked as paid)',
      finishFinanceExpenseLabel: 'Expense on this activity',
      finishFinanceExpenseHelp: 'Club costs (e.g. fuel, accommodation). Leave 0 if none.',
      finishFinanceNetPreview: 'Net for finances (income − expense)',
      finishFinanceConfirm: 'Confirm and finish',
      finishFinanceSubmitting: 'Saving…',
      finishFinanceRashodInvalid: 'Expense must be a non-negative number',
      finishFinanceSuccessNone:
        'The activity was finished. No finance entry was added (net is 0 or nothing to record).',
      finishFinanceSuccessIncome: 'The activity was finished. Income of {{amount}} {{currency}} was recorded.',
      finishFinanceSuccessExpense: 'The activity was finished. Expense of {{amount}} {{currency}} was recorded.',
    },
    users: {
    ...
    uiExtras: {
      ...
      buttons: {
        back: 'Back',
        profileInfo: 'All user information',
        profileSettings: 'Profile settings',
        print: 'Print',
        profileSettingsMenu: 'Settings',
        profileInfoMenu: 'Info',
        printMenu: 'Print',
      },
    ...
    invite: {
      ...
      adminPanel: {
        ...
        shareLinkLabel: 'Member registration link',
        copyLink: 'Copy link',
        linkCopied: 'Link copied!',
        shareHint: 'Send members this link and code — on login they choose register with club code.',
      },
    },
    pdf: {
  ...
  "appLayout": {
    ...
    "myClubNav": "Moj klub",
    "exploreFerate": "Ferate",
    "exploreMountains": "Gore in vrhovi",
    "exploreGuides": "Vodniki",
    "exploreHotels": "Hoteli in nastanitev",
    "exploreMap": "Zemljevid",
    "exploreComingSoon": "Kmalu",
    "clubOverview": "Pregled kluba",
    "tasks": "Naloge",
    "members": "člani",
    "club": "Klub",
  ...
  "actionDetails": {
    ...
    "managementTitle": "Upravljanje",
    "finishFinanceModalTitle": "Zaključi dejavnost in finance",
    "finishFinanceTotalIncome": "Skupni prihodek (vsote označenih kot plačani)",
    "finishFinanceExpenseLabel": "Stroški dejavnosti",
    "finishFinanceExpenseHelp": "Stroški kluba (npr. gorivo, nastanitev). Pustite 0, če ni stroškov.",
    "finishFinanceNetPreview": "Neto za finance (prihodek − stroški)",
    "finishFinanceConfirm": "Potrdi in zaključi",
    "finishFinanceSubmitting": "Shranjevanje …",
    "finishFinanceRashodInvalid": "Stroški morajo biti ne-negativno število",
    "finishFinanceSuccessNone": "Dejavnost je zaključena. V finance ni bil dodan zapis (neto je 0 ali ni prihodka).",
    "finishFinanceSuccessIncome": "Dejavnost je zaključena. V finance je bil vpisan prihodek {{amount}} {{currency}}.",
    "finishFinanceSuccessExpense": "Dejavnost je zaključena. V finance je bil vpisan strošek {{amount}} {{currency}}."
  },
  "users": {
  ...
  "uiExtras": {
    ...
    "buttons": {
      ...
      "print": "Tiskanje",
      "profileSettingsMenu": "Nastavitve",
      "profileInfoMenu": "Info",
      "printMenu": "Tiskaj"
    },
    "block": {
  ...
  "clubs": {
    ...
    "superadmin": {
      ...
      "stats": {
        ...
        "membersLabel": "Članov",
        "actionsLabel": "Akcij",
        "totalMembers": "Člani klubov / skupaj uporabnikov",
