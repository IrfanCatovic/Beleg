        ...
        <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-8">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="mt-1.5 text-sm sm:text-base text-white/80 font-medium flex items-center gap-1.5">
              ...
              {locationSubtitle}
              {showTrailKm &&
                ` · ${akcija.duzinaStazeKm!.toLocaleString(undefined, { minimumFractionDigits: 1, maximumFractionDigits: 1 })} km`}
              {showAscentM && ` · ${akcija.kumulativniUsponM} m ${t('summitPngAscent', { defaultValue: 'uspon' }).toLowerCase()}`}
              {showPeakHeight && ` · ${akcija.visinaVrhM} m`}
              {actionPer > 0 && ` · ${actionPer} PER`}
            ...
            <div className="w-full xl:max-w-[50rem] xl:shrink-0 relative rounded-[28px] border border-gray-100 bg-white shadow-[0_12px_40px_-12px_rgba(16,185,129,0.18)] overflow-hidden">
              ...
              <div className="relative p-7 xl:p-9">
                ...
                <div className="mt-3.5 flex flex-wrap items-center gap-2">
                  ...
                  {showTrailKm && (
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold text-sky-700 bg-sky-50 border border-sky-200">
                  ...
                  {isFerrataAction ? (
                    ...
                    <>
                      ...
                      {actionPer > 0 && (
                        <HeroMini
                          color="emerald"
                          label={t('summitPngPer', { defaultValue: 'PER' })}
