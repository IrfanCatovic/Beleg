/** Owner vs public profile — Faza E. Prefer ID when both sides have it. */
...
/**
 * Logged-out never owns. When both IDs exist, ID wins.
 * Username is fallback only. Empty/undefined never yields owner.
 */
